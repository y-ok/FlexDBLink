...
class CsvUtilsTest {
    ...
    private interface SqlServerDateTimeOffsetResultSet extends ResultSet {
        Object getDateTimeOffset(int columnIndex) throws java.sql.SQLException;
    }
    ...
    void resolveTemporalValue_正常ケース_sqlTypeがDATEでtypeName非DATE_getDate値が返ること()
        ...
        Object result = CsvUtils.resolveTemporalValue(rs, 1, "raw", Types.DATE, "VARCHAR");
                ...
                .newProxyInstance(getClass().getClassLoader(),
                        ...
                        (proxy, method, args) -> {
                            ...
                            if ("getString".equals(method.getName())) {
                                throw new AssertionError("getString should not be called.");
                            }
    ...
    @Test
    void resolveTemporalValue_正常ケース_TIMESTAMP型でgetTimestampが非null_typed値が返ること() throws Exception {
        ResultSet rs = mock(ResultSet.class);
