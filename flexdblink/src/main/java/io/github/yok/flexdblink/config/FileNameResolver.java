...
/**
 * Utility class that dynamically resolves file names for large text/binary
 * columns such as
 * CLOB/BLOB.
 *
 * <p>
 * If a file name pattern is configured per table/column in
 * {@link FilePatternConfig}, this class
 * expands placeholder variables (e.g., {@code {id}}) using the provided values.
 * If no pattern is
 ...
 *
 * <p>
 * This class performs <strong>no I/O</strong>; it only generates file name
 * strings.
 * </p>
 *
...
public class FileNameResolver {
     ...
     * @param values map of values to embed into the pattern (e.g., primary keys),
     *               as {@code {columnName:value}}
     * @param ext    file extension (e.g., {@code "bin"}, {@code "txt"},
     *               {@code "jpg"}, etc.)
     * @return resolved file name; expands a configured pattern if present,
     *         otherwise uses the
